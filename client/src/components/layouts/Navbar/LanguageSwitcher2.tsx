...
const LanguageSwitcher: React.FC = () => {
    ...
    return (
        <div
            className="flex items-center select-none cursor-pointer max-w-[74x] relative"
            onClick={handleClick}
        >
            ...
            {!isHide && (
                <>
                    ...
                    <div className="absolute top-[90%] flex flex-col bg-white border border-gray-300 rounded-md shadow py-1 text-black">
