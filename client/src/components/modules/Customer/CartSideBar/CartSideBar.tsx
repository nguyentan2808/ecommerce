...
const CartSideBar: React.FC = () => {
  ...
  return (
    <>
      <button
        className="hidden sm:block fixed top-1/2 -translate-y-1/2 right-0 w-24 px-2 py-3 rounded-l-lg bg-teal-500 hover:bg-teal-600"
        onClick={onOpen}
      >
        ...
        <div className="p-1">
          <div className="w-full h-full bg-white text-center font-bold text-teal-500 rounded-lg p-1">
            $300
          </div>
        </div>
      </button>
      ...
      >
        ...
        <DrawerContent>
          ...
          <DrawerBody className="h-full flex flex-col items-center justify-center relative">
            <div className="mt-24 flex flex-col items-center justify-center">
              {notFoundLogo}
              <p className="font-semibold text-lg">No products found</p>
            </div>

            <button className="flex justify-between mt-auto mb-2 w-full p-1 rounded-full bg-teal-500 hover:bg-teal-600 text-white">
              <p className="font-semibold p-3">Checkout</p>
              <span className="flex items-center h-full bg-white text-teal-500 font-bold rounded-full px-5">
                $0.00
              </span>
            </button>
          </DrawerBody>
