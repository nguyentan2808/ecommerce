...
export type GetProductByIdQuery = { __typename?: 'Query', product?: { __typename?: 'Product', name: string, id: number } | null };
...
export type UpdateProductMutation = { __typename?: 'Mutation', updateProduct: { __typename?: 'Product', name: string } };
...
export const useCreateCategoryMutation = <
    ...
    useMutation<CreateCategoryMutation, TError, CreateCategoryMutationVariables, TContext>(
      ['CreateCategory'],
      (variables?: CreateCategoryMutationVariables) => fetcher<CreateCategoryMutation, CreateCategoryMutationVariables>(CreateCategoryDocument, variables)(),
      options
    );
...
export const useGetAllCategoryNameQuery = <
    ...
    useQuery<GetAllCategoryNameQuery, TError, TData>(
      variables === undefined ? ['getAllCategoryName'] : ['getAllCategoryName', variables],
      fetcher<GetAllCategoryNameQuery, GetAllCategoryNameQueryVariables>(GetAllCategoryNameDocument, variables),
      options
    );
...
export const useGetCategoriesQuery = <
    ...
    useQuery<GetCategoriesQuery, TError, TData>(
      ...
      fetcher<GetCategoriesQuery, GetCategoriesQueryVariables>(GetCategoriesDocument, variables),
      options
    );
...
export const useRemoveCategoryMutation = <
    ...
    useMutation<RemoveCategoryMutation, TError, RemoveCategoryMutationVariables, TContext>(
      ['RemoveCategory'],
      (variables?: RemoveCategoryMutationVariables) => fetcher<RemoveCategoryMutation, RemoveCategoryMutationVariables>(RemoveCategoryDocument, variables)(),
      options
    );
...
export const useUpdateCategoryMutation = <
    ...
    useMutation<UpdateCategoryMutation, TError, UpdateCategoryMutationVariables, TContext>(
      ['updateCategory'],
      (variables?: UpdateCategoryMutationVariables) => fetcher<UpdateCategoryMutation, UpdateCategoryMutationVariables>(UpdateCategoryDocument, variables)(),
      options
    );
...
export const useGetProductByIdQuery = <
    ...
    useQuery<GetProductByIdQuery, TError, TData>(
      ...
      fetcher<GetProductByIdQuery, GetProductByIdQueryVariables>(GetProductByIdDocument, variables),
      options
    );
...
export const useRemoveProductMutation = <
    ...
    useMutation<RemoveProductMutation, TError, RemoveProductMutationVariables, TContext>(
      ['RemoveProduct'],
      (variables?: RemoveProductMutationVariables) => fetcher<RemoveProductMutation, RemoveProductMutationVariables>(RemoveProductDocument, variables)(),
      options
    );
